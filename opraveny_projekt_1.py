"""
opraveny_projekt_1.py: první projekt (opravený) do Engeto Online Python Akademie
...
user_name = input("username : ")    # Ověření uživatele.
...
numbers_of_texts = []
for numbers in range(len(TEXTS)):                    # Výběr textu.
...
if choice not in numbers_of_texts:
    ...
    words_in_TEXTS = TEXTS[index - 1].split()        # Analýza textu.
